...
!
  SUBROUTINE compute_bc(r_time, r_coords, i_npoints, i_edgebou, r_normal, &
    ...
    CASE(-5) ! tidal outflow boundary conditions
      r_Q_r(1,:) = (5.0_GRID_SR - 4.0_GRID_SR * &
                   (SIN(2.0_GRID_SR*GRID_PI*r_time/(2.0_GRID_SR*43200.0_GRID_SR)))**2) * GRID_GRAV
      r_Q_r(2,:) = 0.0_GRID_SR
      r_Q_r(3,:) = 0.0_GRID_SR
      r_S_r      = r_S_l

    CASE(-6) ! tidal inflow boundary conditions
      r_Q_r(1,:) = r_Q_l(1,:) + 2.0_GRID_SR*(SIN(2.0_GRID_SR*GRID_PI*r_time/43200.0_GRID_SR))**2
      r_Q_r(2,:) = 0.0_GRID_SR
      r_Q_r(3,:) = 0.0_GRID_SR
      r_S_r      = r_S_l
