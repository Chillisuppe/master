...
!--- compute mass (integral over fluid depth) and relative mass
    ...
    ALLOCATE(r_sol(3,p_ghand%i_enumfine*i_numdofs), &
             r_solq(3,p_ghand%i_enumfine,i_equadpts))
    ...
    r_err_mom_l2   = grid_dg_globalnorm_l2(p_ghand, VAR2D_MZERO, r_solq(2,:,:)) / &
                     grid_dg_globalnorm_l2(p_ghand, VAR2D_MZERO) + &
                     grid_dg_globalnorm_l2(p_ghand, VAR2D_MZERO+1, r_solq(3,:,:)) / &
                     grid_dg_globalnorm_l2(p_ghand, VAR2D_MZERO+1)
    r_err_mom_l1   = grid_dg_globalnorm_l1(p_ghand, VAR2D_MZERO, r_solq(2,:,:)) / &
                     grid_dg_globalnorm_l1(p_ghand, VAR2D_MZERO) + &
                     grid_dg_globalnorm_l1(p_ghand, VAR2D_MZERO+1, r_solq(3,:,:)) / &
                     grid_dg_globalnorm_l1(p_ghand, VAR2D_MZERO+1)
    r_err_mom_linf = grid_dg_globalnorm_linf(p_ghand, VAR2D_MZERO, r_solq(2,:,:)) / &
                     grid_dg_globalnorm_linf(p_ghand, VAR2D_MZERO) + &
                     grid_dg_globalnorm_linf(p_ghand, VAR2D_MZERO+1, r_solq(3,:,:)) / &
                     grid_dg_globalnorm_linf(p_ghand, VAR2D_MZERO+1)
